...
/**
 * Theme provider. SSR-safe: accepts `initialMode` resolved server-side from
 * the `rift-theme` cookie so the first paint matches the no-flash class
 * already applied to `<html>` by the shell's root layout.
 */
