...
| ---------------- | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- | ------------ |
| `basePath`       | `base-path`     | Base URL path the component is mounted at (e.g. "/player"). Used to build correct `href` attributes on tab links for SSR and middle-click support. | `string`                                                                              | `"/player"`  |
